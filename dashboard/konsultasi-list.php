	...
	function gej_cf() {
		...
		for(i=0;i<=tot_gej;i++) {
			if (document.getElementsByName("pil_cf_gej[]").item(i).value!="") {
				jum_pil++;
				$("#label_cf_gej_"+i).css("color","#d45622"); document.getElementsByName("pil_cf_gej[]").item(i).style.borderColor="#d45622";
			} else {
				$("#label_cf_gej_"+i).css("color","#333"); document.getElementsByName("pil_cf_gej[]").item(i).style.borderColor="#ccc";
			} 
		}
		for(i=0;i<=tot_gej;i++) {
