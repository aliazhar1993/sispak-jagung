<div class="col col-md-12 col-sm-12">
  ...
  <div class="isian-form">
    <table class="table table-bordered">
      ...
      <?php
      $no = 1;
      $result = $koneksi->query("SELECT * FROM konsultasi, penyakit, user where user.iduser=konsultasi.iduser_kon and konsultasi.idpen_kon=penyakit.idpen order by tgl_kon desc");
