<div class="col col-md-12 col-sm-12">
  ...
  if (isset($_GET['status'])) {
    switch ($_GET['status']) {
      case 'ubah-berhasil':
        echo '<div class="notif-box">Ubah data pengelola berhasil.</div>';
        break;
      case 'hapus-berhasil':
        echo '<div class="notif-box">Hapus data pengelola berhasil.</div>';
        break;
    }
  }
  ?>
  <table class="table table-hover">
    ...
    $no = 1;
    $result = $koneksi->query("SELECT * FROM pengelola order by nama_peng asc");
