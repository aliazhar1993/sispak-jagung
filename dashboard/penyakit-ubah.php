...
if ($row2['gambar_pen'] == "") {
	...
	$gambar = '<img width="300" src="../images/penyakit/' . $row2['gambar_pen'] . '" class="img-pen-list"/><p>Untuk mengubah gambar, silakan unggah gambar baru!</p>';
}
?>
<script>
	$(function() {
		...
		<div class="col-md-4 col-sm-4">
			...
			<div class="row clearfix">
				...
				<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
					<div class="form-group">
						<div class="form-line">
							<input class="form-control" name="nama_pen" type="text" id="nama_pen" placeholder="Nama Penyakit" value="<?= $row2['nama_pen']; ?>" />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row clearfix">
				...
				<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
					<div class="form-group">
						<div class="form-line">
							<textarea class="form-control" id="ket_pen" name="ket_pen" placeholder="Keterangan"><?= $row2['ket']; ?></textarea>
						</div>
					</div>
				</div>
			</div>
			<div class="row clearfix">
				...
				<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
					<div class="form-group">
						<div class="form-line">
							<textarea class="form-control" id="cegah_pen" name="cegah_pen" placeholder="Pencegahan"><?= $row2['pencegahan']; ?></textarea>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row clearfix">
				...
				<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
					<div class="form-group">
						<div class="form-line">
							<textarea class="form-control" id="tanggul_pen" name="tanggul_pen" placeholder="Penanganan"><?= $row2['penanganan']; ?></textarea>
						</div>
					</div>
				</div>
			</div>
